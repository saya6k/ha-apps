# Home Assistant App: Playwright Browser
...
secrets injected bridge-side (1Password / Bitwarden) so they never enter
the conversation, and a live session viewer in the sidebar.

See **[DOCS.md](DOCS.md)** for configuration, architecture, and troubleshooting.
