...
| App | What it is | |
|---|---|---|
| `livekit-wakeword/` ([ha-app-livekit-wakeword](https://github.com/saya6k/ha-app-livekit-wakeword)) | Wyoming wake word — livekit-wakeword runtime + our incremental oWW-compatible bridge. Serves oWW zoo + custom `/share` models. Metadata only — source and CI live in ha-app-livekit-wakeword. | [![Show add-on](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=03f32180_livekit-wakeword&repository_url=https%3A%2F%2Fgithub.com%2Fsaya6k%2Fha-apps) |
| `nemotron-asr-c/` ([ha-app-nemotron-asr-c](https://github.com/saya6k/ha-app-nemotron-asr-c)) | Wyoming STT — Nemotron 0.6B on pure C (nemotron-asr-streaming.c). Boot-time .nemo conversion, true-streaming (stateful mel→encoder→rnnt cascade), hotword biasing. Metadata only. | [![Show add-on](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=03f32180_nemotron-asr-c&repository_url=https%3A%2F%2Fgithub.com%2Fsaya6k%2Fha-apps) |
| `nemo-asr-cpp/` ([ha-app-nemo-asr-cpp](https://github.com/saya6k/ha-app-nemo-asr-cpp)) | Wyoming STT — Nemotron 0.6B on ggml/parakeet.cpp (GGUF). Fast/light CPU sibling; ctypes over a flat C API. Metadata only. | [![Show add-on](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=03f32180_nemo-asr-cpp&repository_url=https%3A%2F%2Fgithub.com%2Fsaya6k%2Fha-apps) |
| `supertonic/` ([ha-app-supertonic](https://github.com/saya6k/ha-app-supertonic)) | Wyoming TTS — supertonic-mnn. Python bridge with auto-precision detection. Metadata only. | [![Show add-on](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=03f32180_supertonic&repository_url=https%3A%2F%2Fgithub.com%2Fsaya6k%2Fha-apps) |
| `voiceprint/` ([ha-app-voiceprint](https://github.com/saya6k/ha-app-voiceprint)) | Speaker-verifying Wyoming STT proxy. Pass-through gate for enrolled voices. CAM++ embeddings on LiteRT. Metadata only. | [![Show add-on](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=03f32180_voiceprint&repository_url=https%3A%2F%2Fgithub.com%2Fsaya6k%2Fha-apps) |
...
| `memory/` ([ha-app-memory](https://github.com/saya6k/ha-app-memory)) | Personal fact memory for Assist over MCP — facts stored with vector embeddings and retrieved by meaning, embedded locally by a llama.cpp sidecar (Qwen3-Embedding-0.6B). Cross-lingual recall. `stage: experimental`. Metadata only. | [![Show add-on](https://my.home-assistant.io/badges/supervisor_addon.svg)](https://my.home-assistant.io/redirect/supervisor_addon/?addon=03f32180_memory&repository_url=https%3A%2F%2Fgithub.com%2Fsaya6k%2Fha-apps) |
...
**Scopes:** `crw` · `livekit-wakeword` · `memory` · `nemotron-asr-c` · `nemo-asr-cpp` · `otelcol` · `supertonic` · `voiceprint` · `wardrowbe` · `zensical` · `repo`
