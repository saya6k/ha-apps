...
`.agents/manifests/repo.md` is the **source of truth** for repo-level AI/agent
guidance. `AGENTS.md`, `GEMINI.md`, and `CLAUDE.md` at the repo root, and
`.github/copilot-instructions.md`, are all symlinks to this file — edit this
