...
* chore: bump wardrowbe to v1.7.0 (#12) @saya6k

**Full Changelog**: https://github.com/saya6k/ha-app-wardrowbe/compare/v4.2.4...v4.2.5

## [4.2.4](https://github.com/saya6k/ha-app-wardrowbe/releases/tag/v4.2.4)

## What's Changed

## Maintenance

* chore: bump wardrowbe to v1.6.0 (#11) @saya6k

**Full Changelog**: https://github.com/saya6k/ha-app-wardrowbe/compare/v4.2.3...v4.2.4

## [4.2.3](https://github.com/saya6k/ha-app-wardrowbe/releases/tag/v4.2.3)

## What's Changed

## Maintenance

* chore: bump wardrowbe to v1.5.1 (#10) @saya6k

**Full Changelog**: https://github.com/saya6k/ha-app-wardrowbe/compare/v4.2.2...v4.2.3
